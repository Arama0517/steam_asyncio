...
class CMsgClientSettings(_message.Message):
    ...
    DEFAULT_APP_UPDATE_BEHAVIOR_FIELD_NUMBER: _ClassVar[int]
    ...
    GAMESCOPE_GUIDE_HOTKEY_FIELD_NUMBER: _ClassVar[int]
    GAMESCOPE_QAM_HOTKEY_FIELD_NUMBER: _ClassVar[int]
    ...
    SETTING_VALIDATION_HOTKEY_FIELD_NUMBER: _ClassVar[int]
    SYSTEM_BLUETOOTH_ENABLED_FIELD_NUMBER: _ClassVar[int]
    VR_SHOW_PERF_GRAPH_IN_HMD_FIELD_NUMBER: _ClassVar[int]
    ...
    default_app_update_behavior: int
    cloud_enabled: bool
