...
class EPublishedFileRevision(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    k_EPublishedFileRevision_AuthorSnapshot: _ClassVar[EPublishedFileRevision]
...
k_EPublishedFileRevision_AuthorSnapshot: EPublishedFileRevision
...
class CPublishedFile_Vote_Request(_message.Message):
    ...
    publishedfileid: int
    vote_up: bool
    def __init__(self, publishedfileid: _Optional[int] = ..., vote_up: bool = ...) -> None: ...
...
class CPublishedFile_Subscribe_Request(_message.Message):
    __slots__ = ("publishedfileid", "list_type", "appid", "notify_client", "include_dependencies")
    PUBLISHEDFILEID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, publishedfileid: _Optional[int] = ..., list_type: _Optional[int] = ..., appid: _Optional[int] = ..., notify_client: bool = ..., include_dependencies: bool = ...) -> None: ...
...
class CPublishedFile_CanSubscribe_Response(_message.Message):
    ...
    can_subscribe: bool
    def __init__(self, can_subscribe: bool = ...) -> None: ...
...
class CPublishedFile_GetSubSectionData_Request(_message.Message):
    ...
    def __init__(self, publishedfileid: _Optional[int] = ..., for_table_of_contents: bool = ..., specific_sectionid: _Optional[int] = ..., desired_revision: _Optional[_Union[EPublishedFileRevision, str]] = ...) -> None: ...
...
class CPublishedFile_GetDetails_Request(_message.Message):
    __slots__ = ("publishedfileids", "includetags", "includeadditionalpreviews", "includechildren", "includekvtags", "includevotes", "short_description", "includeforsaledata", "includemetadata", "language", "return_playtime_stats", "appid", "strip_description_bbcode", "desired_revision", "includereactions", "admin_query")
    ...
    admin_query: bool
    def __init__(self, publishedfileids: _Optional[_Iterable[int]] = ..., includetags: bool = ..., includeadditionalpreviews: bool = ..., includechildren: bool = ..., includekvtags: bool = ..., includevotes: bool = ..., short_description: bool = ..., includeforsaledata: bool = ..., includemetadata: bool = ..., language: _Optional[int] = ..., return_playtime_stats: _Optional[int] = ..., appid: _Optional[int] = ..., strip_description_bbcode: bool = ..., desired_revision: _Optional[_Union[EPublishedFileRevision, str]] = ..., includereactions: bool = ..., admin_query: bool = ...) -> None: ...
...
class PublishedFileDetails(_message.Message):
    ...
    class Tag(_message.Message):
        ...
        adminonly: bool
        display_name: str
        def __init__(self, tag: _Optional[str] = ..., adminonly: bool = ..., display_name: _Optional[str] = ...) -> None: ...
    ...
    class ForSaleData(_message.Message):
        ...
        def __init__(self, is_for_sale: bool = ..., price_category: _Optional[int] = ..., estatus: _Optional[_Union[EPublishedFileForSaleStatus, str]] = ..., price_category_floor: _Optional[int] = ..., price_is_pay_what_you_want: bool = ..., discount_percentage: _Optional[int] = ...) -> None: ...
    ...
    SEARCH_SCORE_FIELD_NUMBER: _ClassVar[int]
...
class CPublishedFile_GetItemInfo_Response(_message.Message):
    ...
    class WorkshopItemInfo(_message.Message):
        __slots__ = ("published_file_id", "time_updated", "manifest_id", "flags", "revision", "author_snapshots")
        PUBLISHED_FILE_ID_FIELD_NUMBER: _ClassVar[int]
        TIME_UPDATED_FIELD_NUMBER: _ClassVar[int]
        ...
        revision: EPublishedFileRevision
        author_snapshots: _containers.RepeatedCompositeFieldContainer[PublishedFileAuthorSnapshot]
        def __init__(self, published_file_id: _Optional[int] = ..., time_updated: _Optional[int] = ..., manifest_id: _Optional[int] = ..., flags: _Optional[int] = ..., revision: _Optional[_Union[EPublishedFileRevision, str]] = ..., author_snapshots: _Optional[_Iterable[_Union[PublishedFileAuthorSnapshot, _Mapping]]] = ...) -> None: ...
...
class CPublishedFile_GetUserFiles_Request(_message.Message):
    ...
    EXCLUDED_CONTENT_DESCRIPTORS_FIELD_NUMBER: _ClassVar[int]
    ADMIN_QUERY_FIELD_NUMBER: _ClassVar[int]
    ...
    excluded_content_descriptors: _containers.RepeatedScalarFieldContainer[_enums_productinfo_pb2.EContentDescriptorID]
    admin_query: bool
    totalonly: bool
    ids_only: bool
    ...
    desired_revision: EPublishedFileRevision
    return_apps: bool
    def __init__(self, steamid: _Optional[int] = ..., appid: _Optional[int] = ..., shortcutid: _Optional[int] = ..., page: _Optional[int] = ..., numperpage: _Optional[int] = ..., type: _Optional[str] = ..., sortmethod: _Optional[str] = ..., privacy: _Optional[int] = ..., requiredtags: _Optional[_Iterable[str]] = ..., excludedtags: _Optional[_Iterable[str]] = ..., required_kv_tags: _Optional[_Iterable[_Union[CPublishedFile_GetUserFiles_Request.KVTag, _Mapping]]] = ..., filetype: _Optional[int] = ..., creator_appid: _Optional[int] = ..., match_cloud_filename: _Optional[str] = ..., cache_max_age_seconds: _Optional[int] = ..., language: _Optional[int] = ..., taggroups: _Optional[_Iterable[_Union[CPublishedFile_GetUserFiles_Request.TagGroup, _Mapping]]] = ..., excluded_content_descriptors: _Optional[_Iterable[_Union[_enums_productinfo_pb2.EContentDescriptorID, str]]] = ..., admin_query: bool = ..., totalonly: bool = ..., ids_only: bool = ..., return_vote_data: bool = ..., return_tags: bool = ..., return_kv_tags: bool = ..., return_previews: bool = ..., return_children: bool = ..., return_short_description: bool = ..., return_for_sale_data: bool = ..., return_metadata: bool = ..., return_playtime_stats: _Optional[int] = ..., strip_description_bbcode: bool = ..., return_reactions: bool = ..., startindex_override: _Optional[int] = ..., desired_revision: _Optional[_Union[EPublishedFileRevision, str]] = ..., return_apps: bool = ...) -> None: ...
...
class CPublishedFile_AreFilesInSubscriptionList_Response(_message.Message):
    ...
    class InList(_message.Message):
        ...
        publishedfileid: int
        inlist: bool
        def __init__(self, publishedfileid: _Optional[int] = ..., inlist: bool = ...) -> None: ...
...
class CPublishedFile_Update_Request(_message.Message):
    __slots__ = ("appid", "publishedfileid", "title", "file_description", "visibility", "tags", "filename", "preview_filename", "spoiler_tag", "image_width", "image_height", "language")
    APPID_FIELD_NUMBER: _ClassVar[int]
    PUBLISHEDFILEID_FIELD_NUMBER: _ClassVar[int]
    TITLE_FIELD_NUMBER: _ClassVar[int]
    FILE_DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    ...
    image_height: int
    language: int
    def __init__(self, appid: _Optional[int] = ..., publishedfileid: _Optional[int] = ..., title: _Optional[str] = ..., file_description: _Optional[str] = ..., visibility: _Optional[int] = ..., tags: _Optional[_Iterable[str]] = ..., filename: _Optional[str] = ..., preview_filename: _Optional[str] = ..., spoiler_tag: bool = ..., image_width: _Optional[int] = ..., image_height: _Optional[int] = ..., language: _Optional[int] = ...) -> None: ...
...
class CPublishedFile_Delete_Request(_message.Message):
    __slots__ = ("publishedfileid", "appid")
    PUBLISHEDFILEID_FIELD_NUMBER: _ClassVar[int]
    APPID_FIELD_NUMBER: _ClassVar[int]
    publishedfileid: int
    appid: int
    def __init__(self, publishedfileid: _Optional[int] = ..., appid: _Optional[int] = ...) -> None: ...
...
class CPublishedFile_GetChangeHistoryEntry_Response(_message.Message):
    __slots__ = ("change_description", "language", "saved_snapshot", "snapshot_game_branch_min", "snapshot_game_branch_max", "manifest_id")
    CHANGE_DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    LANGUAGE_FIELD_NUMBER: _ClassVar[int]
    SAVED_SNAPSHOT_FIELD_NUMBER: _ClassVar[int]
    SNAPSHOT_GAME_BRANCH_MIN_FIELD_NUMBER: _ClassVar[int]
    SNAPSHOT_GAME_BRANCH_MAX_FIELD_NUMBER: _ClassVar[int]
    MANIFEST_ID_FIELD_NUMBER: _ClassVar[int]
    change_description: str
    language: int
    saved_snapshot: bool
    snapshot_game_branch_min: str
    snapshot_game_branch_max: str
    manifest_id: int
    def __init__(self, change_description: _Optional[str] = ..., language: _Optional[int] = ..., saved_snapshot: bool = ..., snapshot_game_branch_min: _Optional[str] = ..., snapshot_game_branch_max: _Optional[str] = ..., manifest_id: _Optional[int] = ...) -> None: ...
...
class CPublishedFile_GetChangeHistory_Request(_message.Message):
    ...
    count: int
    language: int
    def __init__(self, publishedfileid: _Optional[int] = ..., total_only: bool = ..., startindex: _Optional[int] = ..., count: _Optional[int] = ..., language: _Optional[int] = ...) -> None: ...

class CPublishedFile_GetChangeHistory_Response(_message.Message):
    __slots__ = ("changes", "total")
    class ChangeLog(_message.Message):
        __slots__ = ("timestamp", "change_description", "language", "saved_snapshot", "snapshot_game_branch_min", "snapshot_game_branch_max", "manifest_id")
        TIMESTAMP_FIELD_NUMBER: _ClassVar[int]
        CHANGE_DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
        LANGUAGE_FIELD_NUMBER: _ClassVar[int]
        SAVED_SNAPSHOT_FIELD_NUMBER: _ClassVar[int]
        ...
        snapshot_game_branch_max: str
        manifest_id: int
        def __init__(self, timestamp: _Optional[int] = ..., change_description: _Optional[str] = ..., language: _Optional[int] = ..., saved_snapshot: bool = ..., snapshot_game_branch_min: _Optional[str] = ..., snapshot_game_branch_max: _Optional[str] = ..., manifest_id: _Optional[int] = ...) -> None: ...
...
class CPublishedFile_RefreshVotingQueue_Request(_message.Message):
    ...
    desired_revision: EPublishedFileRevision
    def __init__(self, appid: _Optional[int] = ..., matching_file_type: _Optional[int] = ..., tags: _Optional[_Iterable[str]] = ..., match_all_tags: bool = ..., excluded_tags: _Optional[_Iterable[str]] = ..., desired_queue_size: _Optional[int] = ..., desired_revision: _Optional[_Union[EPublishedFileRevision, str]] = ...) -> None: ...
...
class CPublishedFile_QueryFiles_Request(_message.Message):
    ...
    desired_revision: EPublishedFileRevision
    return_reactions: bool
    def __init__(self, query_type: _Optional[int] = ..., page: _Optional[int] = ..., cursor: _Optional[str] = ..., numperpage: _Optional[int] = ..., creator_appid: _Optional[int] = ..., appid: _Optional[int] = ..., requiredtags: _Optional[_Iterable[str]] = ..., excludedtags: _Optional[_Iterable[str]] = ..., match_all_tags: bool = ..., required_flags: _Optional[_Iterable[str]] = ..., omitted_flags: _Optional[_Iterable[str]] = ..., search_text: _Optional[str] = ..., filetype: _Optional[int] = ..., child_publishedfileid: _Optional[int] = ..., days: _Optional[int] = ..., include_recent_votes_only: bool = ..., cache_max_age_seconds: _Optional[int] = ..., language: _Optional[int] = ..., required_kv_tags: _Optional[_Iterable[_Union[CPublishedFile_QueryFiles_Request.KVTag, _Mapping]]] = ..., taggroups: _Optional[_Iterable[_Union[CPublishedFile_QueryFiles_Request.TagGroup, _Mapping]]] = ..., date_range_created: _Optional[_Union[CPublishedFile_QueryFiles_Request.DateRange, _Mapping]] = ..., date_range_updated: _Optional[_Union[CPublishedFile_QueryFiles_Request.DateRange, _Mapping]] = ..., excluded_content_descriptors: _Optional[_Iterable[_Union[_enums_productinfo_pb2.EContentDescriptorID, str]]] = ..., admin_query: bool = ..., totalonly: bool = ..., ids_only: bool = ..., return_vote_data: bool = ..., return_tags: bool = ..., return_kv_tags: bool = ..., return_previews: bool = ..., return_children: bool = ..., return_short_description: bool = ..., return_for_sale_data: bool = ..., return_metadata: bool = ..., return_playtime_stats: _Optional[int] = ..., return_details: bool = ..., strip_description_bbcode: bool = ..., desired_revision: _Optional[_Union[EPublishedFileRevision, str]] = ..., return_reactions: bool = ...) -> None: ...
...
class CPublishedFile_GetAppRelationshipsBatched_Request(_message.Message):
    __slots__ = ("publishedfileids", "filter_relationship")
    PUBLISHEDFILEIDS_FIELD_NUMBER: _ClassVar[int]
    FILTER_RELATIONSHIP_FIELD_NUMBER: _ClassVar[int]
    publishedfileids: _containers.RepeatedScalarFieldContainer[int]
    filter_relationship: int
    def __init__(self, publishedfileids: _Optional[_Iterable[int]] = ..., filter_relationship: _Optional[int] = ...) -> None: ...
...
class CPublishedFile_GetAppRelationshipsBatched_Response(_message.Message):
    ...
    class PublishedFileAppRelationship(_message.Message):
        __slots__ = ("publishedfileid", "result", "app_relationships")
        PUBLISHEDFILEID_FIELD_NUMBER: _ClassVar[int]
        RESULT_FIELD_NUMBER: _ClassVar[int]
        APP_RELATIONSHIPS_FIELD_NUMBER: _ClassVar[int]
        publishedfileid: int
        result: int
        app_relationships: _containers.RepeatedCompositeFieldContainer[CPublishedFile_GetAppRelationshipsBatched_Response.AppRelationship]
        def __init__(self, publishedfileid: _Optional[int] = ..., result: _Optional[int] = ..., app_relationships: _Optional[_Iterable[_Union[CPublishedFile_GetAppRelationshipsBatched_Response.AppRelationship, _Mapping]]] = ...) -> None: ...
    RELATIONSHIPS_FIELD_NUMBER: _ClassVar[int]
    relationships: _containers.RepeatedCompositeFieldContainer[CPublishedFile_GetAppRelationshipsBatched_Response.PublishedFileAppRelationship]
    def __init__(self, relationships: _Optional[_Iterable[_Union[CPublishedFile_GetAppRelationshipsBatched_Response.PublishedFileAppRelationship, _Mapping]]] = ...) -> None: ...
...
class CPublishedFile_SetCollectionChildren_Request(_message.Message):
    __slots__ = ("appid", "publishedfileid", "children")
    APPID_FIELD_NUMBER: _ClassVar[int]
    PUBLISHEDFILEID_FIELD_NUMBER: _ClassVar[int]
    CHILDREN_FIELD_NUMBER: _ClassVar[int]
    appid: int
    ...
    def __init__(self, appid: _Optional[int] = ..., publishedfileid: _Optional[int] = ..., children: _Optional[_Iterable[int]] = ...) -> None: ...
...
class CPublishedFile_SetSubscriptionListFromCollection_Request(_message.Message):
    __slots__ = ("appid", "list_type", "publishedfileid", "add_only")
    APPID_FIELD_NUMBER: _ClassVar[int]
    LIST_TYPE_FIELD_NUMBER: _ClassVar[int]
    PUBLISHEDFILEID_FIELD_NUMBER: _ClassVar[int]
    ADD_ONLY_FIELD_NUMBER: _ClassVar[int]
    appid: int
    list_type: int
    publishedfileid: int
    add_only: bool
    def __init__(self, appid: _Optional[int] = ..., list_type: _Optional[int] = ..., publishedfileid: _Optional[int] = ..., add_only: bool = ...) -> None: ...
...
class CPublishedFile_GetUserVoteSummary_Response(_message.Message):
    ...
    class VoteSummary(_message.Message):
        ...
        vote_against: bool
        reported: bool
        def __init__(self, publishedfileid: _Optional[int] = ..., vote_for: bool = ..., vote_against: bool = ..., reported: bool = ...) -> None: ...
...
class CPublishedFile_GetItemChanges_Request(_message.Message):
    __slots__ = ("appid", "last_time_updated", "num_items_max", "desired_revision")
    APPID_FIELD_NUMBER: _ClassVar[int]
    LAST_TIME_UPDATED_FIELD_NUMBER: _ClassVar[int]
    ...
    num_items_max: int
    desired_revision: EPublishedFileRevision
    def __init__(self, appid: _Optional[int] = ..., last_time_updated: _Optional[int] = ..., num_items_max: _Optional[int] = ..., desired_revision: _Optional[_Union[EPublishedFileRevision, str]] = ...) -> None: ...

class CPublishedFile_GetItemChanges_Response(_message.Message):
    __slots__ = ("update_time", "workshop_items")
    class WorkshopItemInfo(_message.Message):
        __slots__ = ("published_file_id", "time_updated", "manifest_id", "author_snapshots")
        PUBLISHED_FILE_ID_FIELD_NUMBER: _ClassVar[int]
        TIME_UPDATED_FIELD_NUMBER: _ClassVar[int]
        MANIFEST_ID_FIELD_NUMBER: _ClassVar[int]
        AUTHOR_SNAPSHOTS_FIELD_NUMBER: _ClassVar[int]
        ...
        manifest_id: int
        author_snapshots: _containers.RepeatedCompositeFieldContainer[PublishedFileAuthorSnapshot]
        def __init__(self, published_file_id: _Optional[int] = ..., time_updated: _Optional[int] = ..., manifest_id: _Optional[int] = ..., author_snapshots: _Optional[_Iterable[_Union[PublishedFileAuthorSnapshot, _Mapping]]] = ...) -> None: ...
    UPDATE_TIME_FIELD_NUMBER: _ClassVar[int]
    WORKSHOP_ITEMS_FIELD_NUMBER: _ClassVar[int]
    update_time: int
...
class CPublishedFile_GetContentDescriptors_Response(_message.Message):
    __slots__ = ("content_descriptors",)
    class ContentDescriptor(_message.Message):
        __slots__ = ("descriptorid", "accountid", "timestamp", "moderator_set")
        DESCRIPTORID_FIELD_NUMBER: _ClassVar[int]
        ACCOUNTID_FIELD_NUMBER: _ClassVar[int]
        TIMESTAMP_FIELD_NUMBER: _ClassVar[int]
        MODERATOR_SET_FIELD_NUMBER: _ClassVar[int]
        descriptorid: _enums_productinfo_pb2.EContentDescriptorID
        accountid: int
        timestamp: int
        moderator_set: bool
        def __init__(self, descriptorid: _Optional[_Union[_enums_productinfo_pb2.EContentDescriptorID, str]] = ..., accountid: _Optional[int] = ..., timestamp: _Optional[int] = ..., moderator_set: bool = ...) -> None: ...
    CONTENT_DESCRIPTORS_FIELD_NUMBER: _ClassVar[int]
    content_descriptors: _containers.RepeatedCompositeFieldContainer[CPublishedFile_GetContentDescriptors_Response.ContentDescriptor]
    def __init__(self, content_descriptors: _Optional[_Iterable[_Union[CPublishedFile_GetContentDescriptors_Response.ContentDescriptor, _Mapping]]] = ...) -> None: ...

class CPublishedFile_UpdateContentDescriptors_Request(_message.Message):
    __slots__ = ("publishedfileid", "descriptors_to_add", "descriptors_to_remove")
    PUBLISHEDFILEID_FIELD_NUMBER: _ClassVar[int]
    DESCRIPTORS_TO_ADD_FIELD_NUMBER: _ClassVar[int]
    DESCRIPTORS_TO_REMOVE_FIELD_NUMBER: _ClassVar[int]
    publishedfileid: int
    descriptors_to_add: _containers.RepeatedScalarFieldContainer[_enums_productinfo_pb2.EContentDescriptorID]
    descriptors_to_remove: _containers.RepeatedScalarFieldContainer[_enums_productinfo_pb2.EContentDescriptorID]
    def __init__(self, publishedfileid: _Optional[int] = ..., descriptors_to_add: _Optional[_Iterable[_Union[_enums_productinfo_pb2.EContentDescriptorID, str]]] = ..., descriptors_to_remove: _Optional[_Iterable[_Union[_enums_productinfo_pb2.EContentDescriptorID, str]]] = ...) -> None: ...

class CPublishedFile_UpdateContentDescriptors_Response(_message.Message):
    __slots__ = ("timestamp_updated",)
    TIMESTAMP_UPDATED_FIELD_NUMBER: _ClassVar[int]
    timestamp_updated: int
    def __init__(self, timestamp_updated: _Optional[int] = ...) -> None: ...

class CPublishedFile_FileSubscribed_Notification(_message.Message):
    __slots__ = ("published_file_id", "app_id", "file_hcontent", "file_size", "rtime_subscribed", "is_depot_content", "rtime_updated", "revision", "revisions")
    class RevisionData(_message.Message):
        __slots__ = ("revision", "file_hcontent", "rtime_updated", "game_branch_min", "game_branch_max")
        REVISION_FIELD_NUMBER: _ClassVar[int]
        ...
        game_branch_min: str
        game_branch_max: str
        def __init__(self, revision: _Optional[_Union[EPublishedFileRevision, str]] = ..., file_hcontent: _Optional[int] = ..., rtime_updated: _Optional[int] = ..., game_branch_min: _Optional[str] = ..., game_branch_max: _Optional[str] = ...) -> None: ...
    PUBLISHED_FILE_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, published_file_id: _Optional[int] = ..., app_id: _Optional[int] = ..., file_hcontent: _Optional[int] = ..., file_size: _Optional[int] = ..., rtime_subscribed: _Optional[int] = ..., is_depot_content: bool = ..., rtime_updated: _Optional[int] = ..., revision: _Optional[_Union[EPublishedFileRevision, str]] = ..., revisions: _Optional[_Iterable[_Union[CPublishedFile_FileSubscribed_Notification.RevisionData, _Mapping]]] = ...) -> None: ...
