...
class SteamID(int):
    ...
    @classmethod
    def from_invite_code(cls, code, universe=EUniverse.Public):
        """
        ...
        if 0 < accountid < 2**32:
            return cls(accountid, EType.Individual, EUniverse(universe), 1)

    @classmethod
    def from_csgo_friend_code(cls, code, universe=EUniverse.Public):
        """
    ...
    @classmethod
    async def from_url(cls, url, http_timeout=30):
        """
