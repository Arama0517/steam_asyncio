...
class crypto_testcase(unittest.TestCase):
    ...
    def test_sha1_hash(self):
        self.assertEqual(
            crypto.sha1_hash(b'123'),
            b'@\xbd\x00\x15c\x08_\xc3Qe2\x9e\xa1\xff\\^\xcb\xdb\xbe\xef',
        )
        self.assertEqual(
            crypto.sha1_hash(b'999999'),
            b'\x1fU#\xa8\xf55(\x9b4\x01\xb2\x99X\xd0\x1b)f\xeda\xd2',
        )
